...
CONTROL_AGENT_PORT = int(os.getenv("CONTROL_AGENT_PORT", "8784"))
CONTROL_BOT_ID = os.getenv("CONTROL_BOT_ID", "novels").strip() or "novels"
CONTROL_BOT_NAME = os.getenv("CONTROL_BOT_NAME", "NovelsBrasil_Bot").strip() or CONTROL_BOT_ID
CONTROL_CHANNEL_USERNAME = os.getenv("CONTROL_CHANNEL_USERNAME", "@NovelsBrasil").strip()
